...
<div id="kohana-profiler">
	...
	<div class="kohana">
		...
		<table class="profiler">
			<tr class="group">
				<th class="name" colspan="3"><?php echo __('Route') ?></th>
			</tr>
			<tr class="headers">
				<th class="name"><?php echo __('Directory') ?></th>
				<th class="name"><?php echo __('Controller') ?></th>
				<th class="name"><?php echo __('Action') ?></th>
			</tr>
			<tr>
				<td style="text-align: left;"><?php echo Request::initial()->directory(); ?></td>
				<td style="text-align: left;"><?php echo Request::initial()->controller(); ?></td>
				<td style="text-align: left;"><?php echo Request::initial()->action(); ?></td>
			</tr>
		</table>
		</div>
